...
public class PasswordInputView extends AppCompatEditText {
    ...
    public PasswordInputView(Context context, AttributeSet attrs) {
        ...
        final int defaultBorderColor = res.getColor(R.color.colorPrimaryDark);
        ...
        final int defaultPasswordColor = res.getColor(R.color.colorPrimaryDark);
        ...
        passwordPaint.setTextSize(res.getDimension(R.dimen.dimen_12dp));
        //mText = new String();
        setSingleLine(true);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for(int i = 0; i < textLength; i++) {
            ...
            canvas.drawText(mText.toCharArray(),i,1,cx-passwordPaint.getTextSize()/4,cy+passwordPaint.getTextSize()/4,passwordPaint);
