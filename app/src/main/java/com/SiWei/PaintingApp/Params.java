...
public class Params implements Parcelable {
     ...
     * {@link PaletteView#PaletteView(Context, Bitmap, String, boolean, GraffitiListener)}
     */
    ...
    public interface DialogInterceptor {
         ...
         * @return 返回true表示拦截
         */
        boolean onShow(Activity activity, PaletteView paletteView, DialogType dialogType);
    }
}
