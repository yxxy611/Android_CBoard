...
public class ColorPickerDialog extends Dialog {
    ...
    public ColorPickerDialog(Context context, String title,
        ...
        this(context, android.graphics.Color.BLACK, title, listener);
    }
    ...
    private class ColorPickerView extends View {
        ...
        public ColorPickerView(Context context, int height, int width) {
            ...
            mLinePaint.setColor(android.graphics.Color.parseColor("#72A1D1"));
        ...
        private int interpCircleColor(int colors[], float unit) {
            ...
            int c0 = colors[i];
            int c1 = colors[i + 1];
            int a = ave(android.graphics.Color.alpha(c0), android.graphics.Color.alpha(c1), p);
            int r = ave(android.graphics.Color.red(c0), android.graphics.Color.red(c1), p);
            int g = ave(android.graphics.Color.green(c0), android.graphics.Color.green(c1), p);
            int b = ave(android.graphics.Color.blue(c0), android.graphics.Color.blue(c1), p);
        ...
        private int interpRectColor(int colors[], float x) {
            ...
            a = ave(android.graphics.Color.alpha(c0), android.graphics.Color.alpha(c1), p);
            r = ave(android.graphics.Color.red(c0), android.graphics.Color.red(c1), p);
            g = ave(android.graphics.Color.green(c0), android.graphics.Color.green(c1), p);
            b = ave(android.graphics.Color.blue(c0), android.graphics.Color.blue(c1), p);
            return android.graphics.Color.argb(a, r, g, b);
        }
